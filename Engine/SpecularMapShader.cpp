...
SpecularMapShader::SpecularMapShader(const SpecularMapShader& other)
{
...
bool SpecularMapShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, 
		L"../Engine/Content/Shaders/Specular.vs", 
		L"../Engine/Content/Shaders/Specular.ps");
...
bool SpecularMapShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
